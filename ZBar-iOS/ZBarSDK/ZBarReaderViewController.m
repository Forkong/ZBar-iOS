...
@synthesize scanner, readerDelegate,
    supportedOrientationsMask, enableCache, cameraOverlayView,
    cameraViewTransform, cameraDevice, cameraFlashMode, videoQuality,
    readerView, scanCrop, tracksSymbols, showsZBarControls;
...
{
    NSAssert2((long)mode == (long)UIImagePickerControllerCameraCaptureModeVideo,
